...
function handleSubmit(e) {
    ...
    axios.post('http://localhost:5432/cities', body)
        .then(() => {
...
function deleteCard(id) {
    axios.delete(`http://localhost:5432/cities/${id}`)
        .then(() => getCities())
...
function getCities() {
    ...
    axios.get('http://localhost:5432/cities/')
        .then(res => {
...
function getCountries() {
    axios.get('http://localhost:5432/countries')
        .then(res => {
